...
bool
AT42QT1060::anyTouched (Status status)
{
  return status.keys;
}

bool
AT42QT1060::touched (Status status, uint8_t key)
{
  return bitRead (status.keys, key);
}

void
AT42QT1060::enableRelativeDriftCompensation ()
{
...
void
AT42QT1060::disableRelativeDriftCompensation ()
{
  write (RegisterAddresses::AT42QT1060::DRIFT_OPTION,
...
uint8_t
AT42QT1060::getRecalibrationDelay ()
{
  uint8_t rd;
...
void
AT42QT1060::setRecalibrationDelay (uint8_t rd)
{
  write (RegisterAddresses::AT42QT1060::RECALIBRATION_DELAY, rd);
}

uint8_t
AT42QT1060::getKeyDetectThreshold (uint8_t key)
{
  uint8_t threshold;
  readKey (RegisterAddresses::AT42QT1060::KEY_DETECT_THRESHOLD, key,
           threshold);
  return threshold;
}

void
AT42QT1060::setKeyDetectThreshold (uint8_t key, uint8_t threshold)
{
  writeKey (RegisterAddresses::AT42QT1060::KEY_DETECT_THRESHOLD, key,
            threshold);
}

uint8_t
AT42QT1060::getMeasurementIntervalCount ()
{
...
void
AT42QT1060::setMeasurementIntervalCount (uint8_t interval_count)
{
  write (RegisterAddresses::AT42QT1060::LOW_POWER_MODE, interval_count);
}

AT42QT1060::IOMask
AT42QT1060::getIOMask ()
{
  IOMask mask;
...
void
AT42QT1060::setIOMask (IOMask mask)
{
  write (RegisterAddresses::AT42QT1060::IO_MASK, mask.bytes);
}

AT42QT1060::KeyMask
AT42QT1060::getKeyMask ()
{
  KeyMask mask;
...
void
AT42QT1060::setKeyMask (KeyMask mask)
{
...
void
AT42QT1060::setAdjacentKeySuppressionMask (AdjacentKeySuppressionMask mask)
{
  write (RegisterAddresses::AT42QT1060::ADJACENT_KEY_SUPRESSION_MASK,
         mask.bytes);
}

AT42QT1060::PWMMask
AT42QT1060::getPWMMask ()
{
  PWMMask mask;
...
void
AT42QT1060::setPWMMask (PWMMask mask)
{
  write (RegisterAddresses::AT42QT1060::PWM_MASK, mask.bytes);
}

AT42QT1060::DetectionMask
AT42QT1060::getDetectionMask ()
{
  DetectionMask mask;
...
void
AT42QT1060::setDetectionMask (DetectionMask mask)
{
