...
protected:
  ...
  void write (RegisterAddress register_address, const Data &data);
  ...
  template <typename Data>
  void writeKey (RegisterAddress base_register_address, uint8_t key,
                 const Data &data);

  template <typename Data>
  void read (RegisterAddress register_address, Data &data);

  template <typename Data>
  void read (RegisterAddress register_address, Data &data, uint8_t data_size);

  template <typename Data>
  void readKey (RegisterAddress base_register_address, uint8_t key,
                Data &data);
...
private:
  ...
  template <typename Data>
  void writeRegisterBlock (uint8_t register_address_number, const Data &data,
                           uint8_t data_size);

  template <typename Data>
  void readRegisterBlock (uint8_t register_address_number, Data &data,
                          uint8_t data_size);
};
